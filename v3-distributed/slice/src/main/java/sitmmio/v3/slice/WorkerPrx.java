...
public interface WorkerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return workerId(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String workerId(java.util.Map<String, String> context)
    {
        return _iceI_workerIdAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> workerIdAsync()
    {
        return _iceI_workerIdAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> workerIdAsync(java.util.Map<String, String> context)
    {
        return _iceI_workerIdAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_workerIdAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "workerId", null, sync, null);
    ...
    default SpeedResult process(SpeedTask task)
    {
        return process(task, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default SpeedResult process(SpeedTask task, java.util.Map<String, String> context)
    {
        return _iceI_processAsync(task, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<SpeedResult> processAsync(SpeedTask task)
    {
        return _iceI_processAsync(task, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<SpeedResult> processAsync(SpeedTask task, java.util.Map<String, String> context)
    {
        return _iceI_processAsync(task, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<SpeedResult> _iceI_processAsync(SpeedTask iceP_task, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<SpeedResult> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "process", null, sync, null);
    ...
    {
        return "::sitmmio::v3::slice::Worker";
    }
}
